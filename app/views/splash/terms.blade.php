...
<div class="container">
	...
	<div id="small-print" class="conditions">
		<p>For more information on the terms and conditions of use, contact us at info@X-PressCards.com</p>
		<div class="header">
			<p style="font-weight:700; font-size:medium;">Legal Notices</p>
		</div>
		<div class="text">
			<p>We, X-Press Cards Ltd. from here on referred to as X-Press Cards, The Service, the Website, Operators, or Operators of the Website provide it as a public service to our users.</p>
			<p>Please carefully review the following basic rules that govern your use of the service provided by X-press Cards. Please note that your use of the X-Press Cards service constitutes your unconditional agreement to follow and be bound by these Terms and Conditions of Use. If you (the "User") do not agree to them, do not use the Website, provide any materials to the Website or download any materials from them.</p>
		...
		<div class="header">
			<p style="font-weight:700; font-size:medium;">Permitted and Prohibited Uses</p>
		</div>
		<div class="text">
			<p>You may use the Website for the sole purpose of sharing and exchanging cards. You may not use the Website to violate any applicable local, state, national, or international law, including without limitation any applicable laws relating to antitrust or other illegal trade or business practices, federal and state securities laws, regulations promulgated by the U.S. Securities and Exchange Commission, any rules of any national or other securities exchange, and any U.S. laws, rules, and regulations governing the export and re-export of commodities or technical data.</p>
			...
			<p>You may not upload any adult material, viruses, worms, Trojan horses, or other forms of harmful computer code, nor subject the Website's network or servers to unreasonable traffic loads, or otherwise engage in conduct deemed disruptive to the ordinary operation of the Website.</p>
			<p>You are strictly prohibited from communicating on or through the X-Press Cards Service any unlawful, harmful, offensive, threatening, abusive, libelous, harassing, defamatory, vulgar, obscene, profane, hateful, fraudulent, sexually explicit, racially, ethnically, or otherwise objectionable material of any sort, including, but not limited to, any material that encourages conduct that would constitute a criminal offense, give rise to civil liability, or otherwise violate any applicable local, state, national, or international law.</p>
			<p>You are expressly prohibited from compiling and using other Users' personal information, including addresses, telephone numbers, fax numbers, usernames, email addresses or other contact information that may appear on the Website, for the purpose of creating or compiling marketing and/or mailing lists and from sending other Users unsolicited marketing materials, whether by facsimile, email, or other technological means.</p>
		...
		<div class="header">
			<p style="font-weight:700; font-size:medium;">User Submissions</p>
		</div>
		<div class="text">
			<p>The Operators do not want to receive confidential or proprietary information from you through the Website. Any material, information, or other communication you transmit or post ("Contributions") to the X-Press Cards Service will be considered non-confidential.</p>
			...
			<p>The Operators may, but are not obligated to, monitor or review any areas on the X-Press Cards Service where users transmit or post communications or communicate solely with each other, including but not limited to user forums and email lists, and the content of any such communications. The Operators, however, will have no liability related to the content of any such communications, whether or not arising under the laws of copyright, libel, privacy, obscenity, or otherwise. The Operators may edit or remove content from the X-Press Cards Service at their discretion at any time.</p>
		</div>
		<div class="header">
			<p style="font-weight:700; font-size:medium;">Feedback</p>
		</div>
		<div class="text">
			<p>All comments, feedback, suggestions, and other information (known as “submissions”) that you disclose or offer to X-Press Cards, such as your suggestions regarding improvements will become our exclusive property.  We will own exclusively all rights, titles and interest and shall not be limited in any way in the use, commercial or private, of any submissions.  You should not submit any submissions to us if you do not wish to assign such rights to us.  We are and will be under no obligation:  (1) to maintain any submissions in confidence; (2) to pay to you or any third party any compensation for any submissions; or (3) to respond to any submissions.  You and only you will remain solely responsible for the content of any submissions you submit.   </p>
		</div>
		<div class="header">
		...
		<div class="header">
			<p style="font-weight:700; font-size:medium;">Termination</p>
		</div>
		<div class="text">
		...
		<div class="header">
			<p style="font-weight:700; font-size:medium;">WARRANTY DISCLAIMER</p>
		</div>
		<div class="text">
		...
		<div class="header">
			<p style="font-weight:700; font-size:medium;">Notification Of Possible Copyright Infringement</p>
		</div>
		<div class="text">

...
<div id="page">
  <div id="logo">
    <a href="{{URL::route('home')}}"><img src="{{URL::asset('assets/images/mrbunny-white.png')}}"></a>
  </div><!--end logo-->
  ...
  <div id="content">
    ...
    <table>
      ...
      <tr class="odd"><td>Credit Purchase</td><td>{{$credits}}</td><td>{{$unit_price}}</td><td>{{$charge}}</td></tr>
